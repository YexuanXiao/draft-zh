...
\usepackage{fontspec}
\setCJKmainfont[
    BoldFont = Sarasa Gothic SC Bold,
    ItalicFont = Sarasa Gothic SC Light Italic,
    SlantedFont = Sarasa Gothic SC Light Italic,
]{Sarasa Gothic SC}
...
\setmonofont[Ligatures=NoCommon]{Noto Sans Mono}
